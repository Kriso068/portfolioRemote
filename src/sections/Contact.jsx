...
const contactInfo = [
  {
    icon: Mail,
    label: "Email",
    value: "nicolas.gutknecht@numericable.fr",
    href: "#contact",
  },
  {
    icon: Phone,
    label: "Phone",
    value: "+33 (0)6 95 18 17 38",
    href: "tel:+33695181738",
  },
  {
    icon: MapPin,
    label: "Location",
...
export const Contact = () => {
    ...
    const handleSubmit = async (e)=> {
        ...
        const token = captchaToken || recaptchaRef.current?.getValue();
                    ...
                    <div className="space-y-6 animate-fade-in animation-delay-400">
                        ...
                        <div className="glass rounded-3xl p-8 border border-primary/30">
                            ...
                            <p className="text-muted-foreground text-sm">
                                I'm currently looking for a full-time remote position, but I'm also open to select freelance projects and long-term collaborations.
                            </p>
                        </div>
                    </div>
                </div>
